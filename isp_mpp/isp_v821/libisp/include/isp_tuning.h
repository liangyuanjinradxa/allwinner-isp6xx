...
typedef struct vencoder_d3d_cfg {
	...
	HW_U8 e3dLumaEn;
	HW_U8 e3dChromaEn;
	HW_U8 e3dMoveStatusEn;
	HW_U8 e3dPixDiffEn;
	HW_U8 e3dCoefAutoMode;
	HW_U8 e3dMaxCoef;
	HW_U8 e3dMinCoef;
	HW_U8 noiseModeEn;
	HW_S32 lambdaOffset;
	HW_U8 noiseEstVal;
	HW_U8 e3dStatusTh[3];
	HW_U8 e3dMoveStrengthMvTh[3];
	HW_U8 e3dAutoModeAvgTh[10];
	HW_U8 e3dAutoModeCoef[11];
    HW_U32  uRegionWidth;
    HW_U32  uRegionHeight;
    HW_U32  uRegionHorNum;
    HW_U32  uRegionVerNum;
    HW_U32  uRegionTotalNum;
    HW_U8 e3dRegionEnable;
    HW_U8 e3dRegionAutoMode;
    HW_U8 e3dRegionUpDownExpandEn;
    HW_U8 e3dRegionLeftRightExpandEn;
    HW_U8 histogramRegionMvLevelReadEn;
    HW_U8 histogramRegionMvLevelWriteEn;
    HW_U8 regionHeightDiv16;
    HW_U8 regionWidthDiv16;
    HW_U8 smallMvLevelMaxnum[2];
    HW_U32  regionMvLevelRatioTh[3];
#else
	HW_U8 d3d_en;
	HW_U8 d3d_max_mv_th;
...
typedef struct vencoder_motion_search_cfg {
	...
	HW_S32 large_mv_th;
	HW_S32 large_mad_th;
	HW_S32 background_weight;
	HW_FLOAT large_mv_ratio_th;
	HW_FLOAT non_zero_mv_ratio_th;
	HW_FLOAT large_mad_ratio_th;
