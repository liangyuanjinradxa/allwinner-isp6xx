...
#ifdef SENSOR_SC1346
#include "SENSOR_H/sc1346/sc1346_mipi_isp603_20250217_102037_lens3_V32_rgb_30fps.h"
#endif

#ifdef SENSOR_SP1405
#include "SENSOR_H/sp1405/sp1405_mipi_isp603_720p_15fps_rgb.h"
#include "SENSOR_H/sp1405/sp1405_mipi_isp603_720p_15fps_ir.h"
#endif

#ifdef SENSOR_GC1084
#include "SENSOR_H/gc1084/gc1084_mipi_isp603_20250217_102037_lens3_V32_rgb_30fps.h"
#include "SENSOR_H/gc1084/gc1084_mipi_isp603_20250217_102037_lens3_V32_rgb.h"
#include "SENSOR_H/gc1084/gc1084_mipi_isp603_20250217_102905_lens3_V32_ir.h"
#endif
...
#include "SENSOR_H/gc4663/gc4663_mipi_isp603_20241204_ir.h"
#endif

#ifdef SENSOR_IMX258
#include "SENSOR_H/imx258/imx258_mipi_isp603_20240921_color.h"
#endif

#ifdef SENSOR_F37P
#include "SENSOR_H/f37p/f37p_mipi_isp603_20250213_rgb.h"
#include "SENSOR_H/f37p/f37p_mipi_isp603_20250213_ir.h"
#endif

#ifdef SENSOR_F58
#include "SENSOR_H/f58/f58_mipi_isp603_20241214_final_rgb.h"
#include "SENSOR_H/f58/f58_mipi_isp603_20241209_125536_final_ir.h"
#endif

#ifdef SENSOR_SC2336
#include "SENSOR_H/sc2336/sc2336_mipi_isp603_20250215_171639_V3_rgb.h"
#include "SENSOR_H/sc2336/sc2336_mipi_isp603_20250215_171639_V3_ir.h"
#endif

#ifdef SENSOR_SC3336
#include "SENSOR_H/sc3336/sc3336_mipi_isp603_20241224_101421_final_rgb.h"
#include "SENSOR_H/sc3336/sc3336_mipi_isp603_20241224_101421_final_ir.h"
#endif

#ifdef SENSOR_BF2257CS
#include "SENSOR_H/bf2257cs/bf2257cs_mipi_2_isp600_20231219_201540_RGB.h"
#include "SENSOR_H/bf2257cs/bf2257cs_mipi_2_isp600_20231205_154925_IR.h"
#endif

#ifdef SENSOR_SC200AI
#include "SENSOR_H/sc200ai/sc200ai_mipi_isp600_20240327_142457_RGB.h"
#endif

#ifdef SENSOR_OS02G10
#include "SENSOR_H/os02g10/os02g10_dvp_isp603_20250214_rgb.h"
#endif
...
struct isp_cfg_array cfg_arr[] = {
...
#ifdef SENSOR_SP1405
	{"sp1405_mipi",  "sp1405_mipi_isp603_720p_15fps_rgb", 1280, 720, 30, 0, 0, &sp1405_mipi_rgb_isp_cfg},
	{"sp1405_mipi",  "sp1405_mipi_isp603_720p_15fps_ir", 1280, 720, 30, 0, 1, &sp1405_mipi_ir_isp_cfg},
#endif

#ifdef SENSOR_GC1084
	{"gc1084_mipi",  "gc1084_mipi_isp603_20250217_102037_lens3_V32_rgb", 1280, 720, 20, 0, 0, &gc1084_mipi_rgb_isp_cfg},
	{"gc1084_mipi",  "gc1084_mipi_isp603_20250217_102037_lens3_V32_rgb_30fps", 1280, 720, 30, 0, 0, &gc1084_mipi_rgb_isp_cfg},
	{"gc1084_mipi",  "gc1084_mipi_isp603_20250217_102905_lens3_V32_ir", 1280, 720, 20, 0, 1, &gc1084_mipi_ir_isp_cfg},
	{"gc1084_mipi_2",  "gc1084_mipi_isp603_20250217_102037_lens3_V32_rgb", 1280, 720, 20, 0, 0, &gc1084_mipi_rgb_isp_cfg},
	{"gc1084_mipi_2",  "gc1084_mipi_isp603_20250217_102905_lens3_V32_ir", 1280, 720, 20, 0, 1, &gc1084_mipi_ir_isp_cfg},
#endif
	...
	{"gc2083_mipi",  "gc2083_mipi_isp603_20241205_171656_final_rgb_suit_dis_blc", 1280, 720, 20, 0, 0, &gc2083_mipi_rgb1_isp_cfg},
	{"gc2083_mipi_3",  "gc2083_mipi_isp603_20241205_171656_final_rgb_suit_dis_blc", 1280, 720, 20, 0, 0, &gc2083_mipi_rgb1_isp_cfg},
	{"gc2083_mipi_2",  "gc2083_mipi_isp603_20241205_171656_final_rgb_suit", 1280, 720, 20, 0, 0, &gc2083_mipi_rgb_isp_cfg},
#else
	{"gc2083_mipi",  "gc2083_mipi_isp603_20241205_171656_final_rgb_suit", 1920, 1088, 15, 0, 0, &gc2083_mipi_rgb_isp_cfg},
	{"gc2083_mipi",  "gc2083_mipi_isp603_20241205_171656_final_ir", 1920, 1088, 15, 0, 1, &gc2083_mipi_ir_isp_cfg},
	{"gc2083_mipi_2",  "gc2083_mipi_isp603_20241205_171656_final_rgb_suit", 1920, 1088, 15, 0, 0, &gc2083_mipi_rgb_isp_cfg},
...
#ifdef SENSOR_GC4663
	{"gc4663_mipi",  "gc4663_mipi_isp603_20241204_rgb", 2560, 1440, 20, 0, 0, &gc4663_mipi_rgb_isp_cfg},
	{"gc4663_mipi",  "gc4663_mipi_isp603_20241204_ir", 2560, 1440, 20, 0, 1, &gc4663_mipi_ir_isp_cfg},
#endif

#ifdef SENSOR_IMX258
	{"imx258_mipi",  "imx258_mipi_isp603_20240921_color", 1920, 1080, 60, 0, 0, &imx258_mipi_isp_cfg},
#endif

#ifdef SENSOR_F37P
	{"f37p_mipi",  "f37p_mipi_isp603_20250213_rgb", 1920, 1080, 20, 0, 0, &f37p_mipi_rgb_isp_cfg},
	{"f37p_mipi",  "f37p_mipi_isp603_20250213_ir", 1920, 1080, 20, 0, 1, &f37p_mipi_ir_isp_cfg},
#endif

#ifdef SENSOR_F58
	{"f58_mipi",  "f58_mipi_isp603_20241214_final_rgb", 1920, 1080, 20, 0, 0, &f58_mipi_rgb_isp_cfg},
	{"f58_mipi",  "f58_mipi_isp603_20241209_125536_final_ir", 1920, 1080, 20, 0, 1, &f58_mipi_ir_isp_cfg},
#endif

#ifdef SENSOR_SC2336
	{"sc2336_mipi",  "sc2336_mipi_isp603_20250215_171639_V3_rgb", 1920, 1080, 15, 0, 0, &sc2336_mipi_rgb_isp_cfg},
	{"sc2336_mipi",  "sc2336_mipi_isp603_20250215_171639_V3_ir", 1920, 1080, 15, 0, 1, &sc2336_mipi_ir_isp_cfg},
#endif

#ifdef SENSOR_SC3336
	{"sc3336_mipi",  "sc3336_mipi_isp603_20241224_101421_final_rgb", 2304, 1296, 20, 0, 0, &sc3336_mipi_rgb_isp_cfg},
	{"sc3336_mipi",  "sc3336_mipi_isp603_20241224_101421_final_ir", 2304, 1296, 20, 0, 1, &sc3336_mipi_ir_isp_cfg},
#endif

#ifdef SENSOR_BF2257CS
	{"bf2257cs_mipi",  "bf2257cs_mipi_2_isp600_20231219_201540_RGB", 1600, 1200, 30, 0, 0, &bf2257cs_mipi_rgb_isp_cfg},
	{"bf2257cs_mipi",  "bf2257cs_mipi_2_isp600_20231205_154925_IR", 1600, 1200, 30, 0, 1, &bf2257cs_mipi_ir_isp_cfg},
#endif

#ifdef SENSOR_SC200AI
	{"sc200ai_mipi",  "sc200ai_mipi_isp600_20240327_142457_RGB", 1920, 1080, 20, 0, 0, &sc200ai_mipi_isp_cfg},
#endif

#ifdef SENSOR_OS02G10
	{"os02g10_dvp",  "os02g10_dvp_isp603_20250214_rgb", 1920, 1080, 20, 0, 0, &os02g10_dvp_rgb_isp_cfg},
#endif
