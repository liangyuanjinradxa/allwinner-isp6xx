...
struct isp_module_config {
	...
	struct isp_fpn_config fpn_cfg;
	struct isp_dpc_config dpc_cfg;
...
enum isp_features_flags {
	...
	ISP_FEATURES_FPN        =  (1 << 26),
	ISP_FEATURES_DRC        =  (1 << 27),
...
int isp_sunxi_set_cfg0(char *key_name, int offset, int len, unsigned short *key_buf);
