...
struct isp_ae_stats_s {
	...
	HW_U32 avg2[ISP_AE_ROW*ISP_AE_COL];
...
struct isp_af_stats_s {
	HW_U32 af_iir0[ISP_AF_ROW][ISP_AF_COL];
	HW_U32 af_iir0_cnt[ISP_AF_ROW][ISP_AF_COL];
	HW_U32 af_hlt_cnt[ISP_AF_ROW][ISP_AF_COL];
...
struct isp_pltm_stats_s {
	HW_U16 lum_before_gtm[ISP_PLTM_ROW*ISP_PLTM_COL];
	HW_U16 lum_after_gtm[ISP_PLTM_ROW*ISP_PLTM_COL];
	HW_U16 lum_after_pltm[ISP_PLTM_ROW*ISP_PLTM_COL];
};
...
#ifdef USE_ENCPP
	struct encpp_top_config encpp_top_cfg;
