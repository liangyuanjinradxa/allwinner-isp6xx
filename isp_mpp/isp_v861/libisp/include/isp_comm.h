...
enum enc_encpp_sharp_cfg {
	...
	ENCPP_SHARP_CNR_RATIO = 39,//DENOISE
	ENCPP_SHARP_SS_MAP_STREN = 40,
	ENCPP_SHARP_LS_FUS_RATIO = 41,
	ENCPP_SHARP_MAX,
};
...
enum isp_denoise_cfg {
	...
	ISP_DENOISE_FLTPC_CB_STR = 6,
	ISP_DENOISE_FLTPC_CR_STR = 7,
	ISP_DENOISE_LYR0_NR_CRT = 8,
	ISP_DENOISE_LYR1_NR_CRT = 9,
	ISP_DENOISE_LYR2_NR_CRT = 10,
	ISP_DENOISE_MOT_SENS_RATIO = 11,
	ISP_DENOISE_BLOCK_DNR_RT = 12,
	ISP_DENOISE_DTC_HF_WHT_STR = 13,//DTC
	ISP_DENOISE_DTC_HF_BLK_STR = 14,
	ISP_DENOISE_DTC_HF_WHT_CLP = 15,
	ISP_DENOISE_DTC_HF_BLK_CLP = 16,
	ISP_DENOISE_DTC_COR_RT = 17,
	ISP_DENOISE_DTC_LYR0_NR_DLT_CLP = 18,
	ISP_DENOISE_DTC_LYR1_NR_DLT_CLP = 19,
	ISP_DENOISE_DTC_LYR2_NR_DLT_CLP = 20,
	ISP_DENOISE_LYR0_DNR_LM_AMP = 21,//WDR
	ISP_DENOISE_LYR1_DNR_LM_AMP = 22,
	ISP_DENOISE_LYR2_DNR_LM_AMP = 23,
	ISP_DENOISE_LYR0_DNR_LMS_AMP = 24,
	ISP_DENOISE_LYR1_DNR_LMS_AMP = 25,
	ISP_DENOISE_LYR2_DNR_LMS_AMP = 26,
	ISP_DENOISE_MAX,
};
...
enum isp_denoise_comm_cfg {
	...
	ISP_DENOISE_FLTPD_Y_STR = 9,
	ISP_DENOISE_FLTPD_CB_STR = 10,
	ISP_DENOISE_FLTPD_CR_STR = 11,
	ISP_DENOISE_CNT_RATIO0 = 12,
	ISP_DENOISE_CNT_RATIO1 = 13,
	ISP_DENOISE_CNT_RATIO2 = 14,
	ISP_DENOISE_WDR_LM_LW_SLP = 15,
	ISP_DENOISE_WDR_LM_HI_SLP = 16,
	ISP_DENOISE_WDR_LM_MAX_CLIP = 17,
	ISP_DENOISE_WDR_MS_LW_SLP = 18,
	ISP_DENOISE_WDR_MS_HI_SLP = 19,
	ISP_DENOISE_WDR_MS_MAX_CLIP = 20,
...
enum pltm_dynamic_cfg {
	...
	ISP_PLTM_DYNAMIC_MIN_STREN_STEP = 4,
	ISP_PLTM_DYNAMIC_MAX_STREN_CLIP = 5,
	ISP_PLTM_DYNAMIC_SHP_SS_COMP = 6,
	ISP_PLTM_DYNAMIC_SHP_LS_COMP = 7,
	ISP_PLTM_DYNAMIC_D2D_COMP = 8,
	ISP_PLTM_DYNAMIC_D3D_COMP = 9,
	ISP_PLTM_DYNAMIC_DARKNEST_RT = 10,
...
enum isp_pltm_comm_cfg {
	...
	ISP_PLTM_MGC_INT_SMTH   = 17,
	ISP_PLTM_MGC_LUM_ADPT   = 18,
	ISP_PLTM_STS_CEIL_SLP   = 19,
	ISP_PLTM_STS_FLOOR_SLP  = 20,
	ISP_PLTM_STS_GD_RT      = 21,
	ISP_PLTM_ADJK_CRCT_RT   = 22,
	ISP_PLTM_INTERVAL       = 23,
	ISP_PLTM_DARK_LOW_TH    = 24,
	ISP_PLTM_DARK_HIGH_TH   = 25,
	ISP_PLTM_DARKNEST_NUM   = 26,
	ISP_PLTM_MAX,
};
...
enum isp_nrp_comm_cfg {
	...
	ISP_NRP_DLE_MF_CLIP = 5,
	ISP_NRP_DLE_Y_RATIO = 6,
	ISP_NRP_COMM_MAX,
};
...
struct isp_sharp_config {
	...
	HW_U16 sharp_hsv[46];
	HW_U16 sharp_gm_tbl[64];
	HW_U16 sharp_invgm_tbl[64];
