# Makefile for eyesee-mpp/middleware/media/LIBRARY/libisp/isp_dev
CUR_PATH := .
LIBISP_DIR = ./../
...
INCLUDE_DIRS := \
    $(CUR_PATH) \
    $(CUR_PATH)/../include \
    $(CUR_PATH)/../include/V4l2Camera \
    $(CUR_PATH)/../include/device \
...
LOCAL_TARGET_DYNAMIC := libisp_dev
else
LOCAL_TARGET_STATIC := libisp_dev
endif
LOCAL_TARGET_BIN :=
...
LOCAL_CFLAGS := $(CFLAGS) $(inc_paths) $(LIBISP_CFG_CFLAGS) -fPIC -Wall -rdynamic -Wno-unused-variable
#Extra flags to give to the C++ compiler
LOCAL_CXXFLAGS := $(CXXFLAGS) $(inc_paths) $(LIBISP_CFG_CFLAGS) -fPIC -Wall -rdynamic -Wno-unused-variable
...
all: $(target_dynamic) $(target_static)
	...
	@echo ===================================
	@echo build libisp-isp_dev done
	@echo ===================================
